<template>
  <section class="text-gray-700 body-font">
      ...
      <div class="flex flex-wrap -m-10">
        <div class="p-4 md:w-1/2">
          <div class="border-t border-gray-300 p-6 text-center rounded-bl-lg">
            <router-link to="/recipientCreate" class="nav-link">
              <button
    ...
    <section class="text-gray-700 body-font">
      <div class="container px-5 pr-12 mx-auto">
          ...
          <div class="w-full overflow-x-auto">
            <table class="w-full whitespace-no-wrap">
              ...
              >
                ...
                >
                  <td class="px-4 py-3">
                    <div class="flex items-center text-sm">
                      ...
                      <div>
                        <p class="font-semibold" :key="recipient.recipientName">
                ...
                <div class="" v-show="loadRecipientsMessage">{{ loadRecipientsMessage }}</div>
              </tbody>
            </table>
          </div>
          <div
            ...
            <span class="flex col-span-4 mt-2 sm:mt-auto sm:justify-end">
              <nav aria-label="Table navigation">
                <ul class="inline-flex items-center">
                  ...
                  <li>
                    <button
                      class="px-3 py-1 text-white transition-colors duration-150 bg-indigo-500 border border-r-0 border-indigo-600 rounded-md focus:outline-none focus:shadow-outline-purple"
                    >
                      3
                    </button>
                  </li>
...
export default {
  ...
  methods: {
    async loadRecipients() {
      this.recipients = [];
      this.loadRecipientsMessage = "Obteniendo Beneficiarios..."

      this.recipients = await dataService.getRecipients();

      this.loadRecipientsMessage = "";
    }
  }
};
</script>
