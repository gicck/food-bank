      ...
      <div class="container grid px-6 mx-auto">
        ...
        >
          <div class="flex items-center">
            ...
            <span>Reportes de Ordenes</span>
          </div>
          <span>Ver mas &RightArrow;</span>
        </a>
        <!-- With actions -->
                ...
                >
                  <td class="px-4 py-3">
                    <div class="flex items-center text-sm">
                      ...
                      <div>
                        <p class="font-semibold" :key="order.entityName">
                          {{ order.entityName }}
                        </p>
                        <p class="text-xs text-gray-600 dark:text-gray-400">
                          {{ order.entityEmployeeName }}
                        </p>
                      </div>
                    </div>
                  </td>
...
export default {
  ...
  methods: {
    async loadOrders() {
      this.orders = [];
      this.message = "Obteniendo Ordenes...";
